...
export const generateTemplate = (options: Options) => {
  ...
  return`<!DOCTYPE html>
        ...
        <div style="max-width: 147.333px;"><img alt="Company Logo" height="auto" src=${logo} style="display: block; height: auto; border: 0; width: 100%;" title="Company Logo" width="147.333"/></div>
        </div>
        </td>
        </tr>
        </table>
        ...
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="www.example.com" style="height:43px;width:158px;v-text-anchor:middle;" arcsize="10%" strokeweight="0.75pt" strokecolor="#101" fillcolor="#101">
        <w:anchorlock/>
        ...
        <tr>
        <td style="vertical-align: middle; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 6px;"><a href="http://designedwithbeefree.com/" style="text-decoration: none;" target="_blank"></a></td>
        </tr>
        </table>
        </td>
        </tr>
